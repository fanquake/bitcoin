...
export CI_IMAGE_NAME_TAG="docker.io/ubuntu:noble"  # Check that https://packages.ubuntu.com/noble/g++-mingw-w64-x86-64-posix (version 13.2, similar to guix) can cross-compile
