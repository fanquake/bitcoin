...
inline constexpr size_t DEFAULT_KERNEL_CACHE{450_MiB};
//! Default LevelDB write batch size
inline constexpr size_t DEFAULT_DB_CACHE_BATCH{32_MiB};

//! Max memory allocated to block tree DB specific cache (bytes)
inline constexpr size_t MAX_BLOCK_DB_CACHE{2_MiB};
//! Max memory allocated to coin DB specific cache (bytes)
inline constexpr size_t MAX_COINS_DB_CACHE{8_MiB};
