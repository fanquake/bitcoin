...
# CFLAGS
HOST_CFLAGS="-O3 -g -flto -march=native -frecord-gcc-switches -fprofile-use -fprofile-correction -fprofile-partial-training -fprofile-dir=/root/pgo"
...
# LDFLAGS
HOST_LDFLAGS="-Wl,--as-needed -Wl,--dynamic-linker=$glibc_dynamic_linker -Wl,-O3 -flto -march=native -fprofile-use -fprofile-correction -fprofile-partial-training -fprofile-dir=/root/pgo"
...
(
    ...
    cmake -S . -B build \
          ...
          -DAPPEND_CFLAGS="-O3" \
          -DAPPEND_CXXFLAGS="-O3" \
          -DAPPEND_LDFLAGS="-Wl,-O3"

    # Build Bitcoin Core
    cmake --build build -j "$JOBS" ${V:+--verbose} --target bitcoind
