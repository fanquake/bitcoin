...
make -C depends --jobs="$JOBS" HOST="$HOST" \
                                   ...
                                   NO_IPC=1 NO_QT=1 NO_WALLET=1 NO_ZMQ=1
...
# CONFIGFLAGS
CONFIGFLAGS="-DREDUCE_EXPORTS=ON -DBUILD_BENCH=OFF -DBUILD_GUI_TESTS=OFF -DBUILD_FUZZ_BINARY=OFF -DCMAKE_SKIP_RPATH=TRUE -DBUILD_BITCOIN_BIN=OFF -DENABLE_EXTERNAL_SIGNER=OFF"
